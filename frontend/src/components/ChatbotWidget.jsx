...
export default function ChatbotWidget({
  ...
  /*
   * Load eligibility profile + logged-in citizen profile
   */
  useEffect(() => {
    let storedProfile = {};
    ...
    setUserProfile(toChatbotProfile(mergedProfile));
  }, [citizenProfile]);
  ...
  const handleSend = async e => {
    ...
    try {
      ...
      setConversationContext(
        buildContextFromResponse(responseData)
      );
    ...
    >
      ...
      >
        <input
          ...
          placeholder={
            language === 'hi'
              ? 'अपना प्रश्न लिखें (जैसे documents for EWS)...'
